...
const sections = [
  ...
  { title: '4. Data & Privacy', body: 'Your financial data is stored securely using Google Firebase services. We do not sell your personal data to third parties. By using the App, you consent to the collection and use of data as described in our Privacy Policy. You may delete your account and all associated data at any time from the Settings screen.' },
