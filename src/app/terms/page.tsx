...
const sections = [
  ...
  { title: '2. Description of Service', body: 'Ansh is a personal finance tracking application that allows users to record expenses and income, set budgets, track savings goals, split group expenses, scan receipts on-device, and optionally back up their personal data to their own Google Drive. The App is provided "as is" and is intended for personal, non-commercial use only. We do not provide financial advice.' },
  ...
  return (
    <main className="min-h-screen bg-[#08080D] text-white">
      <div className="mx-auto max-w-2xl px-6 py-16">
        ...
        <p className="mb-10 text-sm text-white/50">Effective Date: July 2026</p>
