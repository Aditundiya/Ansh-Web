...
const features = [
  {
    ...
    description: 'Tap to log what you spent. That\'s it. Ansh sorts it into categories so you always know where your money went.',
  },
  {
    emoji: '📈',
  ...
  },
  {
    emoji: '👥',
    title: 'Group Splits',
    description: 'Going halves on dinner? Sharing rent? Add the expense, pick who was involved, and Ansh works out who owes what.',
  },
  {
    emoji: '📄',
  ...
  },
  {
    emoji: '🎯',
    title: 'Savings Goals',
    description: 'Set a goal for something you\'re working towards. Ansh shows you how close you are every time you open the app.',
  },
  {
    emoji: '🔔',
...
const steps = [
  ...
  },
  {
    ...
    description: 'Ansh groups everything automatically. After a week you\'ll already start to see patterns you never noticed before.',
  },
  {
    number: '03',
          ...
          <div className="rounded-3xl border border-indigo-500/20 bg-gradient-to-br from-indigo-950/60 to-[#08080D] p-10 md:p-16 flex flex-col md:flex-row items-center gap-10">
            ...
            <div className="flex-1 text-center md:text-left">
              ...
              <p className="text-white/50 leading-relaxed mb-8">
                Ansh uses a true OLED dark design so it looks great on any Android phone. No blinding white screens, no clutter. Just your numbers, clean and clear.
              </p>
              <a
                href={INSTAGRAM_URL}
                target="_blank"
